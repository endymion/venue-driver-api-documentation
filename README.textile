...
Using that resource URL is pretty simple.  In Ruby for example it looks like this:
	...
	@url = "http://venuedriver/api/venues/184/events/select_tag.html?username=ryan&password=password"
