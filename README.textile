...
<code>
  ...
  => [#<Event:0x1031b08b0 @attributes={"open"=>Sun Jan 02 03:30:00 UTC 2000, "myspace_URL"=>nil, "created_at"=>Fri Dec 18 03:48:14 UTC 2009, "title"=>"Sundays at Tabu", "close"=>Sat Jan 01 13:30:00 UTC 2000, "closed_message"=>nil, ...
  >> @events.size 
  => 38
  ...
  => [#<Flyer:0x102ee6940 @attributes={"asset_file_name"=>"IMG_3020.jpg", "asset_url"=>"/assets/8/original/IMG_3020.jpg", "asset_file_size"=>473217, "asset_content_type"=>"image/jpeg", "id"=>8, "parent_id"=>nil, "asset_updated_at"=>Tue Mar 02 22:00:00 UTC 2010}, @prefix_options={:venue_id=>1, :event_id=>5313}>, #<Flyer:0x102ee68a0 @attributes={"asset_file_name"=>"IMG_2970.jpg", "asset_url"=>"/assets/9/original/IMG_2970.jpg", "asset_file_size"=>603736, ...
  >> @flyers.size
  => 5
